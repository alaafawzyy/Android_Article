...
لما تيجي تعمل app، ساعات بتحتاج تنفذ حاجات تقيلة زي تحميل صورة من النت، وممكن فنفس الوقت تضغط علي button  ولازم التطبيق يرد عليه بسرعة.

لو شغلت كل ده على نفس   الـ  Thread التطبيق هيهنّج ومش هيشتغل كويس.  
...
- مفيد لما تكون بتعمل حاجة زي حفظ داتا على ملف (بتحتاج **Dispatchers.IO**) وبعدين ترجع تعمل حاجة تانية على الـ **main thread** (زي تحديث الـ **UI**).
